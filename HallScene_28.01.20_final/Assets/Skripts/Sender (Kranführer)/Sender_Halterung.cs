...
public class Sender_Halterung : MonoBehaviour
{
    ...
    private void InitClient()
    {
        ...
        remoteEndpoint = new IPEndPoint(ipAddr, 11113);
    /**
    ...
    */
    ...
    void Update()
    {
        ...
        string fail = transform.GetComponentInChildren<activateLamps>().activate.ToString();


        // Stringliste der Eigenschaften und dem Endmarker
        String[] properties = {x_pos, y_pos, z_pos, x_rot, y_rot, z_rot, fail, "<EOF>"};
